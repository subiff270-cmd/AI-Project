      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-950 relative overflow-hidden border-r border-slate-800">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white w-full">
          ...
          <p className="text-lg text-white/80 max-w-md">
            Join thousands of users who use AI-powered insights to manage
            their spending smarter.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-md animate-fade-in-up">
          ...
          <p className={`text-sm mb-8 ${dark ? 'text-slate-400' : 'text-slate-500'}`}>
            Get started with smart expense tracking
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold mb-2 uppercase tracking-wider opacity-60">Name</label>
              <div className="relative">
                <User className={`absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 ${dark ? 'text-slate-400' : 'text-slate-400'}`} />
                <input
                  type="text"
                  value={name}
            ...
            <div>
              <label className="block text-xs font-semibold mb-2 uppercase tracking-wider opacity-60">Email</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-xs font-semibold mb-2 uppercase tracking-wider opacity-60">Password</label>
              <div className="relative">
